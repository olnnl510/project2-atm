...
-- 테이블 데이터 board_login.t_board:~112 rows (대략적) 내보내기
INSERT INTO `t_board` (`i_board`, `title`, `ctnt`, `i_user`, `created_at`, `update_at`, `views`) VALUES
	(1, '호호호', '하하하', 3, '2022-04-27 15:54:36', '2022-04-27 15:54:36', 0),
	...
	(25, 'J조교수는 간호부에게 수혈 준비를.', 'Overcome." 하고 영어로 쓴 것도 있었다. 그리고 마지막에, "나는 죽음과.', 1, '2022-04-27 15:54:36', '2022-04-27 15:54:36', 0),
	...
	(30, 'K교무주임의 음모에서 나온 것임을.', 'V라는 대삼림 지대가 어디인 줄도 알고 거기를 가려면 어느 정거장에서 내릴 것도 다.', 2, '2022-04-27 15:54:36', '2022-04-27 15:54:36', 0),
	...
	(44, 'F역에 내리기는 어려울 듯합니다.', 'J박사는, "오케이. 노형의 피가 다행히 누르요. 혈형은 맞는데." 하고 말하기 어려운.', 2, '2022-04-27 15:54:36', '2022-04-27 15:54:36', 0),
	...
	(51, 'R의 말이 과격함에 놀랐지마는.', 'R는 다시 이야기를 계속하오. "순식간에 둘이 드러누울 만한 구덩이를 아마 두 자.', 2, '2022-04-27 15:54:36', '2022-04-27 15:54:36', 0),
	(52, 'J조교수를 찾아서 정임의 병세도.', 'J박사는, "오케이. 노형의 피가 다행히 누르요. 혈형은 맞는데." 하고 말하기 어려운.', 3, '2022-04-27 15:54:36', '2022-04-27 15:54:36', 0),
	...
	(58, 'M학교로 옮겨 올까." 하고 나는.', 'Y박사가 돌아간 뒤에 나는 정임의 해쓱한 얼굴과 가늘어진 목을 들여다보았소. 그리고.', 3, '2022-04-27 15:54:36', '2022-04-27 15:54:36', 4),
	(59, 'K라는 전속 간호부에게로 가서.', 'R는 다시 이야기를 계속하오. "순식간에 둘이 드러누울 만한 구덩이를 아마 두 자.', 2, '2022-04-27 15:54:36', '2022-04-27 15:54:36', 0),
	(60, 'J조교수는 농담 절반으로 내게.', 'Y박사 말이오. 아내는 삼십칠 도 오 분이나 되는 신열을 가지고도 몸소 만찬을.', 3, '2022-04-27 15:54:36', '2022-04-27 15:54:36', 0),
	(61, 'R라는 사람으로서 경술년에 A씨.', 'A씨의 이야기도 나오고, A씨의 이야기도 나오고, 우리네가 어려서 서로 사귀던 회구담도.', 2, '2022-04-27 15:54:36', '2022-04-27 15:54:36', 0),
	...
	(68, 'R는 인제는 하하하 하는 웃음조차.', 'K도 나와 같이 교회의 직분을 띤 사람이 아니오? 나는 교장실로 들어가기 전에 교무주임.', 3, '2022-04-27 15:54:36', '2022-04-27 15:54:36', 1),
	(69, 'Y박사는 해쓱한 내 아내를 원망치.', 'K학교에 넣는다면 우리 순임이는 M학교에 넣을 테요." 하고 내 아내는 조롱하는.', 3, '2022-04-27 15:54:36', '2022-04-27 15:54:36', 0),
	(70, 'J조교수의 말대로 비워 둔 부실의.', 'F역에 도착하였을 때에는 북만주 광야의 석양의 아름다움은 그 극도에 달한 것 같았소.', 1, '2022-04-27 15:54:36', '2022-04-27 15:54:36', 0),
	...
	(76, 'J조교수가 댄스를 할 때에는 나는.', 'B호텔에서 미스 초이(최 양)를 찾았으나 순임은 없고 어떤 서양 노파가 나와서, "유.', 1, '2022-04-27 15:54:36', '2022-04-27 15:54:36', 0),
	(77, 'F역이라는 것은 삼림 속에 단둘이.', 'R가 돌아간 뒤에 내 아내는 둘째 살촉을 내 심장을 향하고 들이쏘았소. "그럼 어떡하면.', 1, '2022-04-27 15:54:36', '2022-04-27 15:54:36', 0),
	(78, '쿨쿨쿨', 'Y박사가 대문 밖에 나서면서 나더러, "상당히 중하시오." 하고 자기의 오른편 가슴을.', 2, '2022-04-27 15:54:36', '2022-04-27 15:54:36', 0),
	(79, 'J조교수를 찾아서 정임의 병세도.', 'X호실을 찾았소. X호실이라는 것은 결핵 병실인 것을 발견하였소. 이렇게 오진되고 약을.', 2, '2022-04-27 15:54:36', '2022-04-27 15:54:36', 0),
	...
	(90, 'K학교에 가. M학교는 싫어!".', 'J조교수 집으로 전화를 걸었소. 아직오전 여섯 시, 이 때는 밤에 늦도록 댄스요.', 2, '2022-04-27 15:54:36', '2022-04-27 15:54:36', 1),
	...
	(93, 'J조교수는 무시로 정임의 병실에.', 'R는 내 방에 올라와서 내일 하루 지날 일도 이야기하고 또 남 선생과 정임에게 관한.', 1, '2022-04-27 15:54:36', '2022-04-27 15:54:36', 0),
	(94, 'R는 고개를 숙이고 서 있던 내.', 'F역에서도 썰매로 더 가는 삼림 속에 있는 조그마한 정거장으로 집이라고는 정거장 집밖에.', 1, '2022-04-27 15:54:36', '2022-04-27 15:54:36', 0),
	(95, 'K학교에 가. M학교는 싫어!".', 'J조교수를 찾아서 정임의 병세도 물어 보았소. 그러나 나는 순임의 손이 닿지 않도록.', 3, '2022-04-27 15:54:36', '2022-04-27 15:54:36', 0),
	...
	(105, 'C선생은 몇 살이 되시나. 지난.', 'R는 내 방에 올라와서 내일 하루 지날 일도 이야기하고 또 남 선생과 정임에게 관한.', 1, '2022-04-27 15:54:36', '2022-04-27 15:54:36', 0),
	...
	(109, '반가워', '하하하하', 2, '2022-04-27 15:54:36', '2022-04-27 15:54:36', 0),
	(122, '1111', '2222', 12, '2022-06-22 17:27:13', '2022-06-22 17:27:13', 0),
	(125, 'gma', 'gmaa', 12, '2022-06-23 09:52:01', '2022-06-23 09:52:01', 2),
	(126, 'asd', 'qwe', 1, '2022-07-08 10:17:21', '2022-07-08 10:17:21', 1);
...
-- 테이블 데이터 board_login.t_user:~0 rows (대략적) 내보내기
INSERT INTO `t_user` (`i_user`, `uid`, `upw`, `nm`, `gender`, `created_at`, `updated_at`, `profile_img`) VALUES
	(1, 'asd', '1111', '테스트1', 1, '2022-04-27 16:31:02', '2022-04-27 16:31:02', '0483c815-0816-45c9-9426-e32e8644489f.jpg'),
	(2, 'test2', '2222', '테스트2', 0, '2022-04-27 16:51:11', '2022-04-27 16:51:11', '224b3d1f-019b-4bdc-9ed4-04b24c84e336.png'),
	(3, 'test3', '3333', '테스트3', 1, '2022-04-27 16:51:20', '2022-04-27 16:51:20', 'dc1bb79c-4988-4c51-9930-5a0cb3259f31.png'),
	(4, 'test4', '4444', '테스트4', 1, '2022-04-27 16:51:28', '2022-04-27 16:51:28', ''),
	(5, 'maschenny', '4444', '마스체니', 0, '2022-05-09 13:09:59', '2022-05-09 13:09:59', ''),
	(6, '3', '3', '33', 0, '2022-05-23 09:47:18', '2022-05-23 09:47:18', NULL),
	(7, 'kia', '$2y$10$KWEq11egb3e9wtU30ec9hudMnc5C001j.G/27Yyy8Ll/PDEkcYmQe', '키야', 0, '2022-06-22 12:34:19', '2022-06-22 12:34:19', NULL),
	(8, 'qwer', '$2y$10$iEdSBbEmcE2Id8z8JrpPOu4Dp/MFiXaq7yL2i0nPckesldyAiPL6q', 'qwer', 1, '2022-06-22 12:38:24', '2022-06-22 12:38:24', NULL),
	(9, 'test9', '$2y$10$vqkRT81RFwX8l3H57TxbJODOS.nubWFG3QfVouSLOphA0F5KBQS3K', '9999', 1, '2022-06-22 12:40:46', '2022-06-22 12:40:46', NULL),
	(10, '999', '$2y$10$MLgSao8Y1gOxr7uSFxyZcOJFOMVVqPoXzGJhiW5J2WYuutpYTBOvG', '99992', 1, '2022-06-22 12:46:19', '2022-06-22 12:46:19', NULL),
	(11, 'mic', '$2y$10$KJJeXtRmRLLBZtWAYZM.H.iADxXmM9W1iBprvHZcpO0jkmsJD4jbi', 'mic', 1, '2022-06-22 14:47:46', '2022-06-22 14:47:46', NULL),
	(12, 'mas', '$2y$10$pVxzi36II0kx/qSqEyEsg.YaEEYm3LKmNkrMwHy/eYREDf3O9/gHK', '테스트5', 0, '2022-06-22 15:04:45', '2022-06-22 15:04:45', NULL);
