      ...
      <div class="a_header">
        <div class="a_header_1">
          <div class="a_header_profile">
            ...
            <div class="profile_intro" style="margin-left: 15px; font-size: 20px;"><?= isset($_SESSION["login_user"]) ? $login_user["intro"] : $profile_none ?></div>
          </div>
              ...
              <?php foreach ($list1 as $item) { ?>
                <a href="detail.php?i_board=<?= $item["i_board"] ?>">
                  ...
                  <div class="tab_content_set">
                    ...
                    <span class=" tab_content_each"><img class="tab_content_each_profile" src="img/profile/<?= $profile_img ?>"></span>
